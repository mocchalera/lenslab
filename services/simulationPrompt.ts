...
const getClothingPrompt = (clothing: ClothingOption): string => {
  switch (clothing) {
...
const getOutputStylePrompt = (params: SimulationParams): string => {
  ...
  if (params.outputProfile === OutputProfile.HIGH_CONTRAST) {
    return `
